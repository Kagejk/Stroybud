...
const projects = [
  ...
  {
    title: 'Асфальтування біля ТЦ «Епіцентр»',
    category: 'Комерція',
    area: '3 700 м²',
    img: '/images/Епицентр.jpg',
    desc: 'Заїзди, під\'їзди та площадка перед об\'єктом. Розчищення, вивіз ґрунту, щебенева основа, бордюри та асфальтування у два шари з бітумною емульсією між шарами.',
  },
]
